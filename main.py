...
for i in range(label_number):
    ...
    plt.scatter(train_feature_1[i*480:(i+1)*480, 0], train_feature_1[i*480:(i+1)*480, 1], label = '{}'.format(label[i]), marker = '*')
    plt.legend(loc = 'best')
...
for i in range(label_number):
    plt.scatter(train_feature_2[i*480:(i+1)*480, 0], train_feature_2[i*480:(i+1)*480, 1], label = '{}'.format(label[i]), marker = '*')
    plt.legend(loc = 'best')
